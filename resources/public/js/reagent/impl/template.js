...
{return (function() { 
var G__5377__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3447__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3447__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__5380 = res;(G__5380[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5380;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5381){var vec__5383 = p__5381;var id = cljs.core.nth.call(null,vec__5383,(0),null);var class$ = cljs.core.nth.call(null,vec__5383,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",-1508377146))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5384 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5384 === "key")))
{(o[pname_5384] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__5387 = jsprops;(G__5387["defaultValue"] = value);
(G__5387["value"] = null);
(G__5387["onChange"] = ((function (G__5387,on_change,value){
return (function (p1__5385_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5385_SHARP_);
});})(G__5387,on_change,value))
);
return G__5387;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5393 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5393,(0),null);var id = cljs.core.nth.call(null,vec__5393,(1),null);var class$ = cljs.core.nth.call(null,vec__5393,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3447__auto__ = id;if(cljs.core.truth_(or__3447__auto__))
{return or__3447__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5395 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5395,(0),null);var id_class = cljs.core.nth.call(null,vec__5395,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj5399 = {};(obj5399[reagent.impl.util.cljs_argv] = v);
(obj5399[reagent.impl.util.cljs_level] = level);
return obj5399;
})();var k_5400 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5401 = (((k_5400 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5400);if((k_SINGLEQUOTE__5401 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__5401);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4303__auto___5402 = a.length;var i_5403 = (0);while(true){
if((i_5403 < n__4303__auto___5402))
{(a[i_5403] = reagent.impl.template.as_component.call(null,(a[i_5403]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4303__auto___5405 = a.length;var i_5406 = (0);while(true){
if((i_5406 < n__4303__auto___5405))
{if((i_5406 >= first_child))
{(a[i_5406] = reagent.impl.template.as_component.call(null,(a[i_5406]),level));
} else
{}
{
