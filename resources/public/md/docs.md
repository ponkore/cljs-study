...
Two middleware functions are provided by default in the `cljs-study.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `cljs-study.handler` namespace to manage the enabled middleware.
